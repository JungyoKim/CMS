<script lang="ts">
	import PreSalesTable from "$lib/components/pre-sales-table.svelte";
...
<div class="flex flex-col md:h-[calc(100vh-var(--header-height)-theme(spacing.16))] px-4 lg:px-6">
	<div class="flex flex-col md:h-full gap-4">
