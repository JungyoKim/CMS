...
<SelectPrimitive.Portal {...portalProps}>
	...
	>
		...
		<SelectPrimitive.Viewport
			class={cn(
				'h-(--bits-select-anchor-height) min-w-[min(var(--bits-select-anchor-width),_90vw)] w-full scroll-my-1 p-1'
			)}
		>
			{@render children?.()}
		</SelectPrimitive.Viewport>
