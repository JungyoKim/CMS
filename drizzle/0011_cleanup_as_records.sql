DROP TABLE IF EXISTS `as_records_new`;
...
--> statement-breakpoint
INSERT OR IGNORE INTO `as_records_new` (`AS_ID`, `CONTRACT_ID`, `CLIENT_ID`, `request_date`, `request_content`, `response_date`, `response_content`, `cost`, `is_completed`)
